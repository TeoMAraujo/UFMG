...
ENTITY 	Demux_1x2 IS
	...
	S : IN std_logic;
	Y0 : OUT std_logic_vector(0 DOWNTO 0);
	Y1 : OUT std_logic_vector(0 DOWNTO 0)
	);
END Demux_1x2;

-- Design Ports Information
-- Y0[0]	=>  Location: PIN_V4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Y1[0]	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_Y0 : std_logic_vector(0 DOWNTO 0);
SIGNAL ww_Y1 : std_logic_vector(0 DOWNTO 0);
...
-- Equation(s):
-- \Y0~0_combout\ = (\A[0]~input_o\ & !\S~input_o\)
...
-- Equation(s):
-- \Y1~0_combout\ = (\A[0]~input_o\ & \S~input_o\)

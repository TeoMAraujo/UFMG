...
ENTITY 	D_flip_flop IS
	...
	CLK : IN std_logic;
	RST : IN std_logic;
	Q : BUFFER std_logic_vector(0 DOWNTO 0);
	Qn : BUFFER std_logic_vector(0 DOWNTO 0)
	);
END D_flip_flop;

-- Design Ports Information
-- Q[0]	=>  Location: PIN_J11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Qn[0]	=>  Location: PIN_B12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \internal_Q[0]~feeder_combout\ : std_logic;
SIGNAL \RST~input_o\ : std_logic;
SIGNAL internal_Q : std_logic_vector(0 DOWNTO 0);
SIGNAL \ALT_INV_RST~input_o\ : std_logic;
SIGNAL ALT_INV_internal_Q : std_logic_vector(0 DOWNTO 0);
...
ALT_INV_internal_Q(0) <= NOT internal_Q(0);
...
\internal_Q[0]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \internal_Q[0]~feeder_combout\ = \D[0]~input_o\
...
PORT MAP (
	datad => \D[0]~input_o\,
	combout => \internal_Q[0]~feeder_combout\);

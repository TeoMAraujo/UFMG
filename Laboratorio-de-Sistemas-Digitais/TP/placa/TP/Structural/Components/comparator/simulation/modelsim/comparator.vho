...
-- Design Ports Information
-- equal	=>  Location: PIN_W8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\equal~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\equal~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \equal~0_combout\ = \A[0]~input_o\ $ (\B[0]~input_o\)
